            ...
            <div class="card">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name_barang" value="{{ $barang->name_barang}}" disabled>
                    </div>
                    <div class="mb-3">
                        <label>Merek</label>
                    ...
                    <div class="mb-3">
                        <label>Stok</label>
                        <input type="integer" class="form-control" name="stok" value="{{ $barang->stok}}" disabled>
                    </div>
